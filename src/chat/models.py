...
from sqlalchemy import Column, Integer, String, ForeignKey, Text, UUID, TIMESTAMP, func
...
class Source(Base):
    ...
    extended_title = Column(String(255), nullable=False)
